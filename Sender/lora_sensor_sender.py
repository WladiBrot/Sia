...
# Sensor-Module (dht22.py, ky053.py) liegen im selben Ordner wie dieses Skript
...
def main():
    ...
    # Anemometer initialisieren
    try:
        import ky053 as anemometer
        anemometer.setup()
    except ImportError as e:
        print(f"✗ Anemometer-Modul nicht gefunden: {e}")
        print("  Stelle sicher, dass ky053.py im gleichen Ordner wie dieses Skript liegt.")
        return
    ...
    try:
        while True:
            ...
            humidity = None
            if dht22:
                temp_c, humidity = dht22.read_dht22()
